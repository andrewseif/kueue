...
type AdmissionFairSharingApplyConfiguration struct {
	...
	Mode *kueuev1beta1.AdmissionMode `json:"mode,omitempty"`
}
...
func (b *AdmissionFairSharingApplyConfiguration) WithMode(value kueuev1beta1.AdmissionMode) *AdmissionFairSharingApplyConfiguration {
	b.Mode = &value
	return b
}
